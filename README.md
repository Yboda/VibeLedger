...
- Kakao 소셜 로그인을 사용하려면 Supabase `Authentication > Providers > Kakao`에서 Kakao REST API Key/Client Secret을 등록하고, Kakao Developers의 Redirect URI에 Supabase가 안내하는 callback URL을 추가합니다.
